...
export default function MyCards({material,userinfo,likedMat,setMaterials,materials}) {
 ...
 <div className='bookcover' style={{display:'flex',flexDirection:'column', alignItems:'center' ,  padding:10, paddingTop:0}}>
  ...
  <Link className='book-button'  href={{
      pathname: "/edit/[editid]",
      query: { pid: material.pid}
    }} as={"/edit"+"/"+material.pid}><img className='book-image' src='../edit.png'/></Link>
    <button onClick={()=>deleteData()} className='book-button'><img className='book-image' src='../trash.png'/></button>
